...
class PackageInstallScripts {
  ...
  choosePackageToInstall(startingPkg, beingInstalled, blocked, installed, seenManifests) {
  ...
  findInstallablePackage(workQueue, beingInstalled, blocked, installed) {
  ...
  worker(spinner, workQueue, beingInstalled, blocked, installed, waitQueue) {
    var _this5 = this;

    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      while (workQueue.size > 0) {
        // find a installable package
        const pkg = _this5.findInstallablePackage(workQueue, beingInstalled, blocked, installed);
  ...
  init(seedPatterns) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      yield Promise.all(set.spinners.map(function (spinner) {
        return _this6.worker(spinner, workQueue, beingInstalled, blocked, installed, waitQueue);
      }));
